...
old = '  Future<void> _selectLocation(TextEditingController controller) async {'
new = '''  Future<void> _selectParkingLocation(TextEditingController controller) async {
...
print('OK' if 'Future<void> _selectParkingLocation' in content else 'FAIL')
