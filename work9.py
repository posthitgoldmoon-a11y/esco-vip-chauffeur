...
# _showVoucherPurchaseDialog 함수 추가
old_func = '  Future<void> _selectParkingLocation'
new_func = '''  Future<void> _showVoucherPurchaseDialog() async {
    int? selectedAmount;
...
print('충전권 다이얼로그 OK' if '_showVoucherPurchaseDialog' in content else 'FAIL')
